...
class Hand extends cards.CardSet {
    ...
    get value(){
        let value = 0;
        this.cards.forEach(c => value += Pontoon.cardValue(c));
...
class Pontoon {
    ...
    // The value of a card in Pontoon. Assume Aces are low by default, as the player can later decide whether to go high
